...
# Loading all necessary packgages to execute the code.
...
# Declaring the time period, in which the trading strategies are apllied.
...
# Calculating the total return of the S&P500 between 2017-01-01 and today.
...
# Strategy 1: Calculating periods in which the 20-day SMA is above the 50-day SMA.
...
# Strategy 2: Calculating periods in which the 20-day EMA is above the 50-day EMA.
...
# Strategy 3: Calculating periods in which the 50-day SMA is above the 200-day SMA.
...
# Strategy 4: Calculating periods in which the 50-day EMA is above the 200-day EMA.
...
# Strategy 5: Calculating periods in which the 20-day EMA is above the 20-day SMA.
